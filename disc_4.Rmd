...
2. In Rcpp, we must declare the types of input(s) and output(s).
3. Do not forget `;`s.
4. Import the namespace `Rcpp` for things such as `NumericVector`.
5. We need to specify the type of each variable.
